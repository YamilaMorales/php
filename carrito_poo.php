...
class Cliente
{
    ...
    public function __construct($dni = "", $nombre = "", $correo = "", $telefono = "", $descuento = 0.0)
...
class Carrito
{
    ...
    public function imprimirTicket()
    {
        ...
        echo  "<tr><th colspan='2' class='text-center'>MARKET ECO</th></tr>
         <tr>
          <th>Fecha</th>
          <td> " . date("d/m/Y") . " </td>
          </tr>
...
$producto1->nombre = " Portátil 15 \" HP ";
...
$producto2->descripcion = " Esta es una heladera no congelada ";
